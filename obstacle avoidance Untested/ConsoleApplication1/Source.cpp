...

{
	...
	Front.set_memval({ 0,500,400,800,700,1000 });
	Left.set_memval({ 0,500,400,800,700,1000 });
	Right.set_memval({ 0,500,400,800,700,1000 });
	...
	w1.set_memval({ 0,100,100,200,300,350 });
	w2.set_name("Right Wheel");
	w2.set_memval({ 0,100,100,200,300,350 });
	...
	while (true)
	{
		...
		//for(int i = 2 ; i <6; i++)
		//if (sonarRange[i] > 200) sonarRange[i] = 200;
